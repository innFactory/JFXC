...
public class OS
{
    ...
    {
        if(OS == null) { OS = java.lang.System.getProperty("os.name"); }
        return OS;
    }
    ...
    public static String getVersion(){
        if(VERSION == null) { VERSION = java.lang.System.getProperty("os.version"); }
        return VERSION;
    }
    ...
    {
        return getOsName().startsWith("Unix"); // FIXME
    }
